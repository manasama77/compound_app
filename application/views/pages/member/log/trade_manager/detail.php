<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0">Log Trade Manager - <?= $invoice; ?></h1>
			</div>
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="#">Log</a></li>
					<li class="breadcrumb-item active">Log Trade Manager</li>
				</ol>
			</div>
		</div>
	</div>
...
<section class="content">
	<div class="container-fluid">
		<div class="row mt-3 mb-3">
			<div class="col-12">
				<a href="<?= site_url('log/trade_manager'); ?>" class="btn btn-warning btn-block elevation-2">Back to List Invoice</a>
			</div>
		</div>
		<div class="row">
			<div class="col-12">
