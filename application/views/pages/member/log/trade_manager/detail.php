<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0">Catatan Trade Manager - <?= $invoice; ?></h1>
			</div>
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="#">Catatan</a></li>
					<li class="breadcrumb-item active">Catatan Trade Manager</li>
				</ol>
			</div>
		</div>
	</div>
...
<section class="content">
	<div class="container-fluid">
		<div class="row mt-3 mb-3">
			<div class="col-12">
				<a href="<?= site_url('log/trade_manager'); ?>" class="btn btn-dark btn-block elevation-2">
			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">History Paket</h3>
		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">Catatan History Profit</h3>
								...
								?>
									<div>
										...
										<div class="timeline-item">
											...
											<h3 class="timeline-header <?= $color2; ?>"><?= ucwords('profit harian member'); ?></h3>
